      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="h-16 glass-header border-b px-4 sm:px-6 flex items-center justify-between shrink-0 select-none relative z-10">
          ...
          <div className="flex items-center gap-2.5 sm:gap-3">
            ...
            {/* Currency Converter Quick Calculator (Prominent Filled Button, Positioned AFTER Wise Rate) */}
            <div className="relative shrink-0">
              <button
                id="topbar-currency-calculator-btn"
                onClick={() => setCalculatorOpen(!calculatorOpen)}
                className="inline-flex items-center gap-1.5 px-3 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-700 active:scale-95 text-white font-bold text-xs transition-all shadow-xs shadow-indigo-500/20 cursor-pointer shrink-0"
                title="Live USD to PHP Calculator Converter"
              >
                <Calculator className="w-4 h-4 text-white" />
                <span className="hidden sm:inline">Calculate USD to PHP</span>
                      ...
                      <div className="space-y-2.5">
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            placeholder={calcMode === 'USD_TO_PHP' ? "Enter USD amount (e.g. 16)..." : "Enter PHP amount..."}
                        ...
                        <div className="p-3 rounded-xl bg-indigo-50/70 dark:bg-indigo-950/40 border border-indigo-100 dark:border-indigo-900/50 flex justify-between items-center">
                          ...
                          <span className="text-sm font-extrabold font-mono text-indigo-900 dark:text-indigo-100">
                            {calcInput.trim() === '' || isNaN(parsedCalcVal)
                              ? (calcMode === 'USD_TO_PHP' ? '₱0.00' : '$0.00')
                              : (calcMode === 'USD_TO_PHP' 
